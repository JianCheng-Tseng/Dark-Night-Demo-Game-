package com.brentaureli.darknight.Sprites;
...
public class Tube {
    ...
    private static final int LOWEST_OPENING = 120;  /*lower position the top of the bottom can be, must be above
    90 to be above  90 to be above ground level*/
